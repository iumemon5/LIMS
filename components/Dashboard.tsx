                    ...
                    {liveLogs.length === 0 ? (
                        ...
                        liveLogs.map((log, i) => (
                            <div key={log.id} className="relative pl-6 pb-6 group last:pb-0">
                                <div className={`absolute left-0 top-1.5 w-3 h-3 bg-slate-900 border-2 rounded-full z-10 transition-transform group-hover:scale-125 ${
                                    log.action.includes('REJECT') ? 'border-red-500' : 
